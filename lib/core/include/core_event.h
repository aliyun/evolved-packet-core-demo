...
#define event_set_param1(__ptr_e, __param) ((__ptr_e)->param1 = (c_uintptr_t)(__param))
#define event_set_param2(__ptr_e, __param) ((__ptr_e)->param2 = (c_uintptr_t)(__param))
#define event_set_param3(__ptr_e, __param) ((__ptr_e)->param3 = (c_uintptr_t)(__param))
#define event_set_param4(__ptr_e, __param) ((__ptr_e)->param4 = (c_uintptr_t)(__param))
#define event_set_param5(__ptr_e, __param) ((__ptr_e)->param5 = (c_uintptr_t)(__param))
#define event_set_param6(__ptr_e, __param) ((__ptr_e)->param6 = (c_uintptr_t)(__param))
#define event_set_param7(__ptr_e, __param) ((__ptr_e)->param7 = (c_uintptr_t)(__param))
#define event_set_param8(__ptr_e, __param) ((__ptr_e)->param8 = (c_uintptr_t)(__param))
...
#define timer_create(__tm_service, __ptr_e, __duration) event_timer_create((__tm_service), TIMER_TYPE_ONE_SHOT, (__duration), (__ptr_e))
#define periodic_timer_create(__tm_service, __ptr_e, __duration) event_timer_create((__tm_service), TIMER_TYPE_PERIODIC, (__duration), (__ptr_e))
 ...
 *         If else, return CORE_ERROR.
 */
CORE_DECLARE(status_t) event_timedrecv(msgq_id queue_id, event_t *e, c_time_t timeout);

/**
 * Create a timer
 */
CORE_DECLARE(tm_block_id) event_timer_create(tm_service_t *tm_service, tm_type_e type, c_uint32_t duration, c_uintptr_t event);


CORE_DECLARE(void*) event_timer_expire_func_zmq(void *sender, c_uintptr_t param1,
        c_uintptr_t param2, c_uintptr_t param3, c_uintptr_t param4,
        c_uintptr_t param5, c_uintptr_t param6);

CORE_DECLARE(status_t)  event_init(void *context,  char *path, void **receiver, void **sender);
CORE_DECLARE(status_t)  event_final(void **receiver, void **sender);
CORE_DECLARE(status_t)  event_recv_with_timeout(void *receiver, event_t *e, c_time_t timeout);
CORE_DECLARE(status_t)  event_send_by_zmq(void *sender, event_t *e);
