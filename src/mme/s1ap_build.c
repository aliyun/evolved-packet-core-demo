...
status_t s1ap_build_setup_rsp(pkbuf_t **pkbuf)
{
    ...
    *RelativeMMECapacity = mme_self()->relative_capacity;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_S1SetupResponse);
        ...
        pkbuf_t **pkbuf, S1AP_Cause_PR group, long cause, long time_to_wait)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_S1SetupFailure);
            ...
            pkbuf_t **s1apbuf, enb_ue_t *enb_ue, pkbuf_t *emmbuf)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_DownlinkNasTransport);
            ...
            pkbuf_t **s1apbuf, mme_ue_t *mme_ue, pkbuf_t *emmbuf)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    asn_uint642INTEGER(&UEAggregateMaximumBitrate->uEaggregateMaximumBitRateUL, subscription_data->ambr.uplink);
    asn_uint642INTEGER(&UEAggregateMaximumBitrate->uEaggregateMaximumBitRateDL, subscription_data->ambr.downlink);
    ...
    while(sess)
    {
        ...
        while(bearer)
        {
            ...
            item = core_calloc(1, sizeof(S1AP_E_RABToBeSetupItemCtxtSUReqIEs_t));
            ...
            e_rab->e_RABlevelQoSParameters.allocationRetentionPriority.priorityLevel = bearer->qos.arp.priority_level;
            e_rab->e_RABlevelQoSParameters.allocationRetentionPriority.pre_emptionCapability = !(bearer->qos.arp.pre_emption_capability);
            e_rab->e_RABlevelQoSParameters.allocationRetentionPriority.pre_emptionVulnerability = !(bearer->qos.arp.pre_emption_vulnerability);
            ...
            //rv = s1ap_ip_to_BIT_STRING(&bearer->sgw_s1u_ip, &e_rab->transportLayerAddress);
            s1u_ip = mme_get_s1u_ip_by_cell_id(enb_ue->enb->enb_id);
            if (s1u_ip == NULL) {
                s1u_ip = &bearer->sgw_s1u_ip;
            }
            rv = s1ap_ip_to_BIT_STRING(s1u_ip, &e_rab->transportLayerAddress);
    ...
    UESecurityCapabilities->encryptionAlgorithms.buf = core_calloc(UESecurityCapabilities->encryptionAlgorithms.size, sizeof(c_uint8_t));
    UESecurityCapabilities->encryptionAlgorithms.bits_unused = 0;
    UESecurityCapabilities->encryptionAlgorithms.buf[0] = (mme_ue->ue_network_capability.eea << 1);

    UESecurityCapabilities->integrityProtectionAlgorithms.size = 2;
    UESecurityCapabilities->integrityProtectionAlgorithms.buf = core_calloc(UESecurityCapabilities->integrityProtectionAlgorithms.size, sizeof(c_uint8_t));
    UESecurityCapabilities->integrityProtectionAlgorithms.bits_unused = 0;
    UESecurityCapabilities->integrityProtectionAlgorithms.buf[0] = (mme_ue->ue_network_capability.eia << 1);

    SecurityKey->size = SHA256_DIGEST_SIZE;
    SecurityKey->buf = core_calloc(SecurityKey->size, sizeof(c_uint8_t));
    ...
    c_uint16_t nr_ue_sec = htons(0xe000);
    
    bit_string = &NRUESecurityCapabilities->nRencryptionAlgorithms;
    bit_string->size = 2;
    bit_string->buf = core_calloc(bit_string->size, sizeof(c_uint16_t));
    memcpy(bit_string->buf, &nr_ue_sec, 2);
    
    bit_string = &NRUESecurityCapabilities->nRintegrityProtectionAlgorithms;
    bit_string->size = 2;
    bit_string->buf = core_calloc(bit_string->size, sizeof(c_uint16_t));
    memcpy(bit_string->buf, &nr_ue_sec, 2);
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_InitialContextSetupRequest);
            ...
            pkbuf_t **s1apbuf, mme_bearer_t *bearer, pkbuf_t *esmbuf)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_ERabSetupRequest);
            ...
            pkbuf_t **s1apbuf, mme_bearer_t *bearer, pkbuf_t *esmbuf)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_ERabModifyRequest);
        ...
        S1AP_Cause_PR group, long cause)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_ERabReleaseCommand);
    ...
    pkbuf_t **s1apbuf, enb_ue_t *enb_ue, S1AP_Cause_PR group, long cause)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_UeContextReleaseCommand);
...
status_t s1ap_build_paging(pkbuf_t **s1apbuf, mme_ue_t *mme_ue)
{
    ...
    *CNDomain = S1AP_CNDomain_ps;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_Paging);
        ...
        S1AP_SONConfigurationTransfer_t *son_configuration_transfer)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_MmeConfigurationTransfer);
...
status_t s1ap_build_path_switch_ack(pkbuf_t **s1apbuf, mme_ue_t *mme_ue)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_PathSwitchAck);
    ...
    S1AP_Cause_PR group, long cause)
{
    ...
    *ENB_UE_S1AP_ID = enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_PathSwitchFailure);

    return CORE_OK;
}

status_t s1ap_build_e_rab_modification_confirm(pkbuf_t **s1apbuf, mme_ue_t *mme_ue)
{
    status_t rv;
    ...
    S1AP_E_RABModifyItemBearerModConf_t	 *E_RABModifyItemBearerModConf = NULL;
    ...
    d_trace(3, "[MME] E_RAB modification confirm\n");

    memset(&pdu, 0, sizeof (S1AP_S1AP_PDU_t));
    pdu.present = S1AP_S1AP_PDU_PR_successfulOutcome;
    pdu.choice.successfulOutcome = core_calloc(1, sizeof(S1AP_SuccessfulOutcome_t));

    successfulOutcome = pdu.choice.successfulOutcome;
    successfulOutcome->procedureCode = S1AP_ProcedureCode_id_E_RABModificationIndication;
    successfulOutcome->criticality = S1AP_Criticality_reject;
    successfulOutcome->value.present = S1AP_SuccessfulOutcome__value_PR_E_RABModificationConfirm;
    ...
    *ENB_UE_S1AP_ID = enb_ue->enb_ue_s1ap_id;
    ...
    item = core_calloc(1, sizeof(S1AP_E_RABModifyItemBearerModConfIEs_t));
    d_assert(item, s1ap_free_pdu(&pdu); return CORE_ERROR, "Null param");
    ...
    E_RABModifyItemBearerModConf = &item->value.choice.E_RABModifyItemBearerModConf;
    E_RABModifyItemBearerModConf->e_RAB_ID = mme_ue->ebi;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_ERabModificationConfirm);
...
status_t s1ap_build_handover_command(pkbuf_t **s1apbuf, enb_ue_t *source_ue)
{
    ...
    *HandoverType = source_ue->handover_type;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_HandoverCommand);
        ...
        pkbuf_t **s1apbuf, enb_ue_t *source_ue, S1AP_Cause_t *cause)
{
    ...
    *ENB_UE_S1AP_ID = source_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_HandoverPreparationFailure);
    ...
    *HandoverType = *handovertype;
    ...
    while(sess)
    {
        ...
        while(bearer)
        {
            ...
            //rv = s1ap_ip_to_BIT_STRING(&bearer->sgw_s1u_ip, &e_rab->transportLayerAddress);
            s1u_ip = mme_get_s1u_ip_by_cell_id(target_ue->enb->enb_id);
            if (s1u_ip == NULL) {
                s1u_ip = &bearer->sgw_s1u_ip;
            }
            rv = s1ap_ip_to_BIT_STRING(s1u_ip, &e_rab->transportLayerAddress);
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_HandoverRequest);
...
status_t s1ap_build_handover_cancel_ack(pkbuf_t **s1apbuf, enb_ue_t *source_ue)
{
    ...
    *ENB_UE_S1AP_ID = source_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_HandoverCancelAck);
            ...
            *enb_statustransfer_transparentContainer)
{
    ...
    *ENB_UE_S1AP_ID = target_ue->enb_ue_s1ap_id;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_MmeStatusTransfer);
        ...
        S1AP_Cause_PR group, long cause)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_ErrorIndication);
        ...
        S1AP_UE_associatedLogicalS1_ConnectionListRes_t *partOfS1_Interface)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_S1Reset);
        ...
        S1AP_ENB_UE_S1AP_ID_t *enb_ue_s1ap_id)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_S1ResetPartial);
        ...
        S1AP_UE_associatedLogicalS1_ConnectionListRes_t *partOfS1_Interface)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_S1ResetAck);
        ...
        pkbuf_t **s1apbuf, sbc_pws_data_t *sbc_pws)
{
    ...
    *NumberofBroadcastRequest = sbc_pws->number_of_broadcast;
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_WriteReplaceWarningRequest);
        ...
        pkbuf_t **s1apbuf, sbc_pws_data_t *sbc_pws)
{
    ...
    mme_inc_cnt_s1ap_out(CNT_S1AP_OUT_KillRequest);
