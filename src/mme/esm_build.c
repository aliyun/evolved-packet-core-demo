        ...
        pkbuf_t **pkbuf, mme_sess_t *sess, nas_esm_cause_t esm_cause)
{
    ...
    mme_inc_cnt_nas_out(CNT_NAS_OUT_PdnConnectivityReject);
...
status_t esm_build_information_request(pkbuf_t **pkbuf, mme_bearer_t *bearer)
{
    ...
    d_assert(nas_security_encode(pkbuf, mme_ue, &message) == CORE_OK && *pkbuf, return CORE_ERROR,);
    
    mme_inc_cnt_nas_out(CNT_NAS_OUT_InformationRequest);
        ...
        pkbuf_t **pkbuf, mme_sess_t *sess)
{
    ...
    mme_inc_cnt_nas_out(CNT_NAS_OUT_ActivateDefaultBearerContextRequest);
        ...
        pkbuf_t **pkbuf, mme_bearer_t *bearer)
{
    ...
    mme_inc_cnt_nas_out(CNT_NAS_OUT_ActivateDedicatedBearerContextRequest);
        ...
        pkbuf_t **pkbuf, mme_bearer_t *bearer, int qos_presence, int tft_presence)
{
    ...
    mme_inc_cnt_nas_out(CNT_NAS_OUT_ModifyBearerContextRequest);
        ...
        pkbuf_t **pkbuf, mme_bearer_t *bearer, nas_esm_cause_t esm_cause)
{
    ...
    mme_inc_cnt_nas_out(CNT_NAS_OUT_DeactivateBearerContextRequest);
